...
public class SDRelationshipDestinationImpl extends ASTWrapperPsiElement implements SDRelationshipDestination {

  public SDRelationshipDestinationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDVisitor visitor) {
    visitor.visitRelationshipDestination(this);
  }
