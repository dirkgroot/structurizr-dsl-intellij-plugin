...
public class SDTagsArgumentImpl extends ASTWrapperPsiElement implements SDTagsArgument {

  public SDTagsArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDVisitor visitor) {
    visitor.visitTagsArgument(this);
  }
