...
public class SDViewsSectionImpl extends ASTWrapperPsiElement implements SDViewsSection {

  public SDViewsSectionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDVisitor visitor) {
    visitor.visitViewsSection(this);
  }
