...
public class SDPropertyDefinitionImpl extends ASTWrapperPsiElement implements SDPropertyDefinition {

  public SDPropertyDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
