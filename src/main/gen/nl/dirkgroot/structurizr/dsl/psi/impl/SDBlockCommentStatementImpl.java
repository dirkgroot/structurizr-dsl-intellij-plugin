...
public class SDBlockCommentStatementImpl extends SDStatementImpl implements SDBlockCommentStatement {

  public SDBlockCommentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SDVisitor visitor) {
    visitor.visitBlockCommentStatement(this);
  }
