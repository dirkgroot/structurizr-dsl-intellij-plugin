...
public class SDKeywordWithPropertyBlockImpl extends ASTWrapperPsiElement implements SDKeywordWithPropertyBlock {

  public SDKeywordWithPropertyBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SDVisitor visitor) {
    visitor.visitKeywordWithPropertyBlock(this);
  }
